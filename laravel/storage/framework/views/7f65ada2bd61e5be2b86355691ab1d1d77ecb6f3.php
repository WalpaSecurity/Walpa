 ...
 <table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
   ...
   <table align="center" border="0" cellpadding="0" cellspacing="0" width="600">
	 ...
	 <img src="<?php echo e(asset('img/logo-walpa1.png')); ?>" alt="WALPA SECURITY" width="80" height="80" style="display: block;" />
	 ...
	 <tr>
	  <td>
    <h2> <?php echo e($firstName); ?>, </h2>
		<h3 style="font-size: 19px; color: #052347; font-weight: bold; text-align: center;"> Merci d'avoir fait un don de <?php echo e($amount); ?> <?php echo e($type); ?> pour notre oeuvre.</h3>
    <p> C'est grâce à vous que nous pouvons améliorer tous les jours notre développement. </p>
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
		 <tr>
		 ...
		 <tr>
		  <td width="260" valign="top">
		   <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			 <td align="center">
			  <img src="<?php echo e(asset('img/Octocat.png')); ?>" alt="" width="100" height="100" style="display: block;" />
			 </td>
			</tr>
			<tr>
			 <td align="center" style="padding: 25px 0 0 0;">
				 <img src="<?php echo e(asset('img/a.jpg')); ?>" alt="" width="100" height="100" style="display: block;" />
			 </td>
			</tr>
   </table>
  </td>
   ...
   <table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
     ...
     <p style="padding-left: 20px; width: 350px; display: -webkit-inline-box; text-align: justify; font-size: 12px; color: dimgrey; font-weight: initial;">
	  ...
	  <tr>
 	<th>
		<!-- <p style="padding-left: 20px; width: 350px; display: -webkit-inline-box; text-align: justify; font-size: 12px; color: dimgrey; font-weight: initial;">kj</p>
		<a style="padding-left: 20px; width: 350px; display: -webkit-inline-box; text-align: justify; font-size: 12px; color: #ff6600; font-weight: initial;" href="">jkjk</a>
  -->
  </th>
 </tr>
	 <tr>
	  ...
	  <tr>
	   <td  align="center">
		<a href="" style="color: transparent">
					<img src="https://pbyp.fr/webroot/img/RS-fb.png"alt="facebook">
				</a>
				<a href="" style="color: transparent">
					<img src="https://pbyp.fr/webroot/img/RS-in.png"alt="linkedin">
				</a>
	   </td>
	  </tr>
