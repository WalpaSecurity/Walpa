...
export default class Profile extends Component {
    ...
    renderRepo = () =>{
        ...
        for (var i = 0; i< this.state.test.length; i++ ){
            display.push(<tr><td>{i}</td><td><a href="#" data-toggle="modal" data-target="#exampleModal" onClick={this.handleListrepoFile.bind(this)}>{this.state.test[i].file_name}</a></td><td>{this.state.test[i].url}</td>
